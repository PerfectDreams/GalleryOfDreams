...
import net.perfectdreams.galleryofdreams.backend.utils.emotes.Emotes
 ...
 */
fun InlineMessage<*>.styled(content: String, prefix: String = Emotes.DefaultStyledPrefix.asMention) {
 ...
 * @param prefix  the emote prefix of the styled message
 */
fun createStyledContent(content: String, prefix: String = Emotes.DefaultStyledPrefix.asMention) = "$prefix **|** $content"